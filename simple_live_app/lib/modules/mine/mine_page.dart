...
class MinePage extends StatelessWidget {
  ...
  Widget _buildLeadingIcon(
    ...
    var bgColor = baseColor.withValues(alpha: isDark ? 0.20 : 0.12);

    if (baseColor == const Color(0xFF24292E)) {
      // GitHub color
      ...
      } else if (baseColor == Colors.pink) {
        iconColor = const Color(0xFFF48FB1);
      } else if (baseColor == Colors.purple) {
        iconColor = const Color(0xFFCE93D8);
      } else if (baseColor == Colors.cyan) {
        iconColor = const Color(0xFF80DEEA);
      } else if (baseColor == Colors.amber.shade700) {
        iconColor = const Color(0xFFFFD54F);
      } else if (baseColor == Colors.redAccent) {
        iconColor = const Color(0xFFEF9A9A);
      } else if (baseColor == Colors.redAccent.shade100) {
          ...
          children: [
              ...
              children: [
                ListTile(
                  leading: _buildLeadingIcon(
                      context, Remix.history_line, Colors.blue),
                ...
                ListTile(
                  leading: _buildLeadingIcon(
                      context, Remix.account_circle_line, Colors.green),
                ...
                ListTile(
                  leading:
                      _buildLeadingIcon(context, Icons.devices, Colors.teal),
                ...
                ListTile(
                  leading:
                      _buildLeadingIcon(context, Remix.link, Colors.orange),
            ...
            _buildCard(
              ...
              children: [
                ListTile(
                  leading: _buildLeadingIcon(
                      context, Remix.moon_line, Colors.indigo),
                ...
                ListTile(
                  leading: _buildLeadingIcon(
                      context, Remix.home_2_line, Colors.pink),
                ...
                ListTile(
                  leading: _buildLeadingIcon(
                      context, Remix.play_circle_line, Colors.purple),
                ...
                ListTile(
                  leading: _buildLeadingIcon(
                      context, Remix.timer_2_line, Colors.amber.shade700),
                ...
                ListTile(
                  leading: _buildLeadingIcon(
                      context, Remix.apps_line, Colors.blueGrey),
                ...
                if (kDebugMode)
                  ListTile(
                    leading: _buildLeadingIcon(
                        context, Remix.bug_line, Colors.redAccent),
            ...
            _buildCard(
              ...
              children: [
                ListTile(
                  leading: _buildLeadingIcon(context, Remix.error_warning_line,
                ...
                ListTile(
                  leading: _buildLeadingIcon(
                      context, Remix.github_line, const Color(0xFF24292E)),
                ...
                ListTile(
                  leading: _buildLeadingIcon(
                      context, Remix.upload_2_line, Colors.redAccent),
